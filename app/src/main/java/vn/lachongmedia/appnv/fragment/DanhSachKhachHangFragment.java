...
public class DanhSachKhachHangFragment extends Fragment {
    public DanhSachKhachHangFragment() {
...
*/
        ...
        cuaHangs.add(new CuaHang());
        cuaHangs.add(new CuaHang());
        AdapterRecyclerDanhSachKhachHang adapterRecyclerDanhSachTinNhan=new AdapterRecyclerDanhSachKhachHang(getActivity(),cuaHangs);
        recyclerViewAlbum.setAdapter(adapterRecyclerDanhSachTinNhan);
        adapterRecyclerDanhSachTinNhan.setOnItemClickedListener(new AdapterRecyclerDanhSachKhachHang.OnItemClickedListener() {
            @Override
            public void onItemClick(int postion, View v) {
                startActivity(new Intent(getActivity(), ChiTietKhachHangActivity.class));
            }
        });
        return rootView;
    }
