...
public class AdapterRecyclerTaoGhiChu extends RecyclerView.Adapter<AdapterRecyclerTaoGhiChu.ItemRowHolder> {
    ...
    public AdapterRecyclerTaoGhiChu(Context context, ArrayList<CuaHang> listCuaHang) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_danhsachtaoghichu, null);
