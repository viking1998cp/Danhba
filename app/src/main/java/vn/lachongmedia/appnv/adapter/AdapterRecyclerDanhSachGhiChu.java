...
public class AdapterRecyclerDanhSachGhiChu extends RecyclerView.Adapter<AdapterRecyclerDanhSachGhiChu.ItemRowHolder> {
    ...
    public AdapterRecyclerDanhSachGhiChu(Context context, ArrayList<CuaHang> listCuaHang) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v;
        if (viewType == 0) {
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_header_danhsachphanhoi, null);
        } else {
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_danhsachghichu, null);
        }
